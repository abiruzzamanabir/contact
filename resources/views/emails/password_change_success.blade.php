            ...
            <table width="100%">
                <tr>
                    <td style="padding: 20px 0">
                        <p>Hello, <strong>{{ $data->fast_name }}</strong></p>
                        <p>We are happy to inform you that your password has been successfully updated.</p>
                        <p><strong>Email Address:</strong> {{ $data->email }}</p>
                        <p><strong>New Password:</strong> {{ $password }}</p>
                        <p>If you did not request this change, please contact our support team immediately.</p>
                        <a href="{{ route('admin.login.page') }}" class="button">Login Now</a>
                        <p>Best regards,<br /><strong>{{ Config::get('app.name') }} Team</strong></p>
                    </td>
                </tr>
            </table>
        </div>
